...
Phase 2 — Tier B cases `01`–`08` (scripted loop, energy block, first-pass, inject-mutation, kill, human reject, cue hotfix, deferred emit), script bees, reset + run-case runner.
